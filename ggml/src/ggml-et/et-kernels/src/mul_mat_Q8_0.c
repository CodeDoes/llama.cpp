...
#define KSPLIT_MIN_K_BLOCKS        99999  /* disabled — K-split has intermittent stream error bug */
#define KSPLIT_SMALL_ROWS_K_BLOCKS 99999   /* disabled — K-split has intermittent stream error bug */
